...
export const PORT_RANGES = {
  zmqData:   { start: 51810, end: 51890, label: 'ZMQ Data (PUB/SUB)' },
  zmqCmd:    { start: 51811, end: 51891, label: 'ZMQ Command (REQ/REP)' },
