...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes! We support MT5 and cTrader platforms. The app connects directly to your local trading terminal for real-time data.',
  },
  {
    question: 'How does the local connection work?',
    answer: 'HedgeEdge connects to your local MT5 or cTrader terminal running on your computer. No VPS or cloud service required - your data stays local and secure.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Absolutely. All trading data flows directly between your local terminal and the app via secure IPC. Your credentials are never sent to external servers.',
  },
];
