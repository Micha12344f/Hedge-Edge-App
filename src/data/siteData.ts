export const tiersData = [
  ...
  {
    name: "Strategy Accelerator Session",
    price: "£397",
    originalPrice: "£697",
    description: "60-minute 1-on-1 call plus your personal hedge plan ready to deploy.",
    features: [
  ...
  },
  {
    ...
    price: "£1,597",
    description: "Done-for-you hedge system, from setup to monitoring.",
    features: [
